...
```{r glyph-merc, warning = F, fig.align='center', fig.width=7, warning = F}
plot <- map + 
...
```{r glyph-albers, warning = F, fig.align='center', fig.width=7, warning = F, message = F}
plot +
  # Different map projection
  coord_map('albers', lat0 = 45.5, lat1 = 29.5)
```

```{r glyph-gnomonic, warning = F, fig.align='center', fig.width=7, warning = F, message = F}
plot +
  # Different map projection
  coord_map('gnomonic')
```
